...
firebase.auth().onAuthStateChanged(function(user) {
  ...
  var userProfilePicListItem = document.getElementById('userProfilePicListItem');
  var userName = document.getElementById('userName');
  var createButton = document.querySelector('#create-button a');
  var pricingButton = document.getElementById('pricing-button');
  var markTestsButton = document.getElementById('mark-tests-button');
...
var db = firebase.firestore();
    ...
    userProfilePicListItem.style.display = 'flex';
...
document.getElementById('logout-button').addEventListener('click', function(event) {
  ...
  firebase.auth().signOut().then(function() {
    ...
    userName.textContent = '';  // Clear the username
  ...
  */
  ...
  firebase.auth().onAuthStateChanged((user) => {
    ...
    if (user) {
      ...
      document.getElementById('userProfilePic').src = 'giphy.gif';
